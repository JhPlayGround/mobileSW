...
public class SetGPS extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tgLocationChange = (ToggleButton)findViewById(R.id.tgLocationChagne);
        ...
        tgLocationChange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try{
                    if(tgLocationChange.isChecked()){
                        Toast.makeText(getApplicationContext(),"위치정보 수신중 . . .",Toast.LENGTH_SHORT).show();
                        tv.setText("뀽뀨뀨유루유류뀨뀨뀨뀽");
                        ...
                        tv.setText("안되요오오오옹");
                        Toast.makeText(getApplicationContext(),"위치정보 미수신",Toast.LENGTH_SHORT).show();
    ...
    private  LocationListener mLocationListener = new LocationListener() {
        public void onLocationChanged(Location location) {
            ...
            Toast.makeText(getApplicationContext(),"위치 정보를 받았습니다.",Toast.LENGTH_SHORT);
        ...
        public ClothesFragment newInstance(String Slat) {
